...
; The jmptable uses a bit number to encode the "best implementation for machine type" value.
	...
	BIF_BULL    = 10		; AMD Bulldozer CPUs
...
; for 32-bit and 64-bit operating systems.
	...
	BULL	= 00000400h		; AMD Bulldozer CPUs
	...
	MAYBE_FMA3 = 04000000h		; This _FMA3 implementation may be best on some CPUs
...
PRCENTRY2 MACRO procname, mem_needed, best_impl_for
	...
	ENDIF
	IFDEF IMPL_ALL_FMA3
	IF (@INSTR (,&procname,yfft)) NE 0
		bif = bif OR MAYBE_FMA3
	ENDIF
	ENDIF
