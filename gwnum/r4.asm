...
buildfor         + P4_64                        ,	r4_pass1sc64 16K, 8, 4
buildfor CORE_64 + P4_32                        ,	r4_pass1sc80 20K, 8, 4
...
buildfor                                        ,	r4_pass1sc32 24K, 768, 4
...
buildfor         + P4_32                + K10   ,	r4_pass1sc96 72K, 768, 4
...
buildfor                                + K10_32,	r4_pass1sc112 112K, 10, 4
buildfor CORE    + P4_32        + K8    + K10   ,	r4_pass1sc32 40K, 1280, 4
buildfor                                        ,	r4_pass1sc64 80K, 1280, 4
buildfor                                        ,	r4_pass1sc96 120K, 1280, 4
buildfor CORE    + P4_32                        ,	r4_pass1sc96 144K, 1536, 4
buildfor CORE_32                + K8    + K10   ,	r4_pass1sc96 144K, 1536, 2
buildfor                                        ,	r4_pass1sc96 144K, 1536, 1

buildfor                                        ,	r4_pass1sc32ac 8K, 8, 4
buildfor         + P4_32                        ,	r4_pass1sc64ac 16K, 8, 4
buildfor         + P4_32                        ,	r4_pass1sc96ac 24K, 8, 4
